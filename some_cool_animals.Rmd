...
These tabsets let me make tabs and tabset-fade creates simple tab fade when switching between tabs 
...
![Ringtail cat (courtesy of zoo)](img/ringtail_cat.jpg) 
We'll also learn about 'knitr::include_graphics()'

Add a few fun facts: 

 - They can rotate their rear feet 180 degrees
 - They are not endangered, they are just very elusive 
